...
export const metadata: Metadata = {
  ...
  description:
    "How Expense Tracker handles your data — what we collect, how it's used, and your choices.",
};
...
export default function PrivacyPolicyPage() {
  return (
    <>
      ...
      <p>
        This Privacy Policy explains how <strong>Expense Tracker</strong>&nbsp;(the
        ...
        tool for tracking your own income and expenses, and we collect as little
        as possible.
      </p>

      <h2>1. Using the Service without an account</h2>
      <p>
        You can use the entire tracker <strong>without signing in</strong>. In
        this guest mode, your transactions, wallets, recurring items, and
        settings are stored only in your browser&apos;s{" "}
        <strong>local storage</strong> on your device. This data never leaves
        your device, and we cannot see it. Clearing your browser data removes it.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Your tracker data</strong> — the transactions, amounts,
          categories, descriptions, dates, wallets, and recurring items you
          save, so they can sync across your devices.
        </li>
        <li>
      ...
      <p>
        We do <strong>not</strong> connect to your bank, and we never ask for or
        collect bank credentials, card numbers, or real account balances — only
        the figures you type in yourself.
      </p>

      <h2>3. How we use your information</h2>
      <ul>
        <li>To create and maintain your account.</li>
        <li>To save your tracker data and sync it across your devices.</li>
      ...
      <p>
        ...
        transactions, wallets, and recurring items, your profile photo, and your
        authentication record. Guest data is removed by clearing your browser
        storage.
      </p>
      ...
      <p>
        The Service is intended for a general audience. If you are below the age
        of digital consent in your jurisdiction, please use the Service only
        with the involvement of a parent or guardian. We do not knowingly
        collect data from children where prohibited by law; contact us if you
        believe a child has provided us personal information and we will delete
        it.
      </p>
      ...
      <ul>
        ...
        <li>
          Export your data as a JSON backup or a spreadsheet, or transfer it to
          another device via the in-app QR code feature.
        </li>
        <li>Delete your account and all associated data.</li>
      </ul>
      <p>
        Any file you export, and any QR code you generate to transfer data, are
        created <strong>on your device</strong>, from data already on your
        device, at the moment you ask for them. The resulting file or code is{" "}
        <strong>not uploaded to or stored by us</strong> — what you do with it,
        including saving, printing, or sharing it, is entirely up to you.
      </p>
      <p>
