...
const eslintConfig = defineConfig([
  ...
  ...nextTs,
  {
    rules: {
      ...
      // The smart components (analytics cumulative sums, dialog form resets)
      // use local-variable reassignment / declaration ordering that the React
      // Compiler lint flags but is safe at runtime — keep that style rather
      // than retyping the whole UI as part of the framework migration.
